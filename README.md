...
### [AI Data Analyst Agent](https://github.com/Rohan-jpg-ux/ai-data-analyst-agent)
Conversational AI agent for automated data analysis, visualization, and reporting  
`Python` · `Claude API` · `Pandas` · `Data Visualization`

### [FlagForge](https://github.com/Rohan-jpg-ux/FlagForge)
Feature flag management service with rule-based targeting  
`Java` · `Spring Boot` · `REST API`

### [Cloud Event Pipeline](https://github.com/Rohan-jpg-ux/Cloud-event-pipeline)
...
**Messaging:** Kafka / AWS MSK · Redis / ElastiCache  
**Data:** DynamoDB · PostgreSQL · Pinecone  
**Cloud / Infra:** AWS (EKS · Lambda · SageMaker · S3 · KMS) · Docker · Kubernetes · ArgoCD  
**APIs:** REST · GraphQL · gRPC  
**AI / ML:** Claude API · RAG pipelines · FAISS · PyTorch · BERT
